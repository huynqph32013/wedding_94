        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="marriage.html">Marriage</a>
                    </li>
                    <li class="nav-item">
        ...
        <div class="row">
            <div class="col-lg-6 padding_0">
                <div class="abiut_images_main">
                    ...
                    <div class="main"><img src="assets/images/img-3.png" class="image_3"></div>
                </div>
            </div>
            <div class="col-lg-6 padding_0">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-6 padding_left_0">
                <div class="marriage_img"><img src="assets/images/marriage-img.png"></div>
            </div>
            <div class="col-lg-6">
                <div class="marriage_taital_main">
                    ...
                    <div class="marriage_section_2">
                        <div class="marriage_taital_left">
                            <div class="car_box">
                                <img src="assets/images/car-img.png" class="car_image">
                            </div>
                        </div>
                    ...
                    <div class="marriage_section_2">
                        <div class="marriage_taital_left">
                            <div class="car_box">
                                <img src="assets/images/balls-img.png" class="car_image">
                            </div>
                        </div>
                        <div class="marriage_taital_right">
                    ...
                    <div class="marriage_section_2">
                        <div class="marriage_taital_left">
                            <div class="car_box">
                                <img src="assets/images/water-bottle-img.png" class="car_image">
                            </div>
                        </div>
                        <div class="marriage_taital_right">
    ...
    <div class="container">
        ...
        <div class="blog_section_2">
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="image_5"><img src="assets/images/img-4.png"></div>
                </div>
            </div>
        </div>
    </div>
