...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="?url=/">
            ...
            <div class="sidebar-brand-text mx-3">Nhóm <sup>94</sup> đồ cưới</div>
        </a>
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" href="?url=list_customer" data-target="#collapseTwo"
        ...
        <!-- Nav Item - Pages Collapse Menu -->
        <li class="nav-item">
            <a class="nav-link collapsed" href="?url=list_post" data-target="#collapseTwo"
               aria-expanded="true" aria-controls="collapseTwo">
        ...
        <!-- Nav Item - Pages Collapse Menu -->
        <li class="nav-item">
            <a class="nav-link collapsed" href="?url=list_categories" data-target="#collapseTwo"
               aria-expanded="true" aria-controls="collapseTwo">
